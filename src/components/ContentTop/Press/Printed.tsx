...
export default function Printed() {
  ...
  return (
    <Styles.ContentTop>
      ...
      <Link href="mailto: ascom@iplanfor.fortaleza.ce.gov.br">ascom@iplanfor.fortaleza.ce.gov.br</Link><br />
      <Link href="mailto: iplanfordigital@gmail.com">iplanfordigital@gmail.com</Link><br /><br />

      <Styles.PressCard>
        <Styles.PressContent>
          <h2>Impressa</h2>
          <br />
          <div>Jornal O Povo (Fortaleza, Brasil) <br /><br /> 3 de Setembro de 2023</div>
