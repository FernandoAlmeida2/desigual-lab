...
const MainContainer = styled.div<{
  ...
  padding: 2.34375vw;
  animation: ${(props) =>
    props.currentTopic === "initial" ? "fadeIn 1s" : "mymove 1s"};
  animation-timing-function: ease-in-out;
  -webkit-animation-timing-function: ease-in-out;

  background-image: ${(props) =>
    props.currentTopic === "initial"
...
const ContentBottom = styled.div<{
  ...
  animation: ${(props) =>
    props.currentTopic === "initial" ? "none" : "mymove-2 1s"};
  animation-timing-function: ease-in-out;
  -webkit-animation-timing-function: ease-in-out;
  @keyframes mymove-2 {
    0% {
...
const ContentPoint = styled.div<{
  ...
  background-color: ${(props) =>
    props.currentTopic === "initial" ? "none" : "rgb(229, 196, 0, 0.9)"};
  border: ${(props) =>
    props.currentTopic === "initial" ? "0.4vw solid #fff" : "none"};
